...
urlpatterns = [
  ...
  path('category/edit_category/<int:pk>', views.edit_category, name = 'edit_category'),
  path('category/delete_category/<int:pk>', views.delete_category, name = 'delete_category'),
  #posts
